...
var waypoint = new Waypoint({
  ...
  handler: function() {
    ...
    p[3].setAttribute("style", "width:35%;transition:2s all;");
    p[4].setAttribute("style", "width:25%;transition:2.3s all;");
...
//   });
  ...
  strings: ["Majharul Islam", "a Web Designer","a Laravel Developer",],
  smartBackspace: true,
   typeSpeed: 100,
   backSpeed: 100,
   loop: true,
